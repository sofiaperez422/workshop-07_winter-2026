...
**when pH = 0, the model predicts that abalone change in shell surface area per day is -18.5. (Note to self: this is not necessarily something biologically realistic, but its something the model generates).**
...
**predicted is the model predictions for change in shell surface rea per day**
